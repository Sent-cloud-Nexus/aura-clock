...
import { Settings, MapPin, RefreshCw, X, Check } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center text-center p-8 w-full max-w-4xl">
        ...
        {/* Date Display */}
        <h2 
          className="text-xl md:text-3xl font-light tracking-wide transition-colors duration-300"
          style={{ color: theme.dateText }}
        >
          {formatDate(time)}
        </h2>
      ...
      <button 
        ...
        className="absolute bottom-8 right-8 p-4 rounded-full glass shadow-lg transition-all hover:scale-105 active:scale-95 group"
      >
        <Settings 
          size={24} 
